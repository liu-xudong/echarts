...
// 柱状图2
(function() {
	let myColor = ['#1089e7', '#f57474', '#56d0e3', '#f88448', '#8878f6']
	// 实例化对象
...
(function() {
	...
	let option = {
		...
		legend: {
			// 如果series 对象有name值，则 legend 可以不用写 data
			// data: ['新增粉丝', '新增游客'],
			// 修改图例组件 文字颜色
			textStyle: {
				color: '#4c9bfd',
		...
		series: [{
				name: '新增粉丝',
				type: 'line',
				data: [24, 40, 101, 134, 90, 230, 210, 230, 128, 230, 210, 120],
				smooth: true
			},
			{
				name: '新增游客',
				...
				areaStyle: {
					color: new echarts.graphic.LinearGradient(
						0, 0, 0, 1, [{
							...
							{
								offset: 0.8,
								color: "rgba(1,132,213,0.1)" // 渐变结束色
							}
						],
						false
					),
			...
			},
			{
				...
				areaStyle: {
					color: new echarts.graphic.LinearGradient(
						0, 0, 0, 1, [{
								offset: 0,
								color: "rgba(0,216,135,0.4)" // 渐变起始色
							},
							{
								offset: 0.8,
								color: "rgba(0,216,135,0.1)" // 渐变结束色
							}
						],
						false
					),
